...
import 'package:gtecgolsuperadmin/screens/super_admin/course_management/super_admin_course_batch.dart';
...
class _AdminAddCourseState extends State<AdminAddCourse> {
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          if (courseId == null) {
                            await provider.SuperAdmincreateCourseprovider(
                            ...
                            await provider.SuperAdminupdateCourse(
                          ...
                          await provider.SuperAdminfetchCoursesprovider();
  ...
  Widget build(BuildContext context) {
    final courseProvider = Provider.of<SuperAdminauthprovider>(context);
                                                        ...
                                                        if (confirm == true) {
                                                          try {
                                                            await Provider.of<
                                                                    ...
                                                                    listen:
                                                                        false)
                                                                .SuperAdmindeleteCourseprovider(
                                                                    course
                                                                        .courseId);
                                                            ScaffoldMessenger
                                                                    .of(context)
