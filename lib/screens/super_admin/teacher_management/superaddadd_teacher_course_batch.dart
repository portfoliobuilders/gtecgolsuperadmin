...
import 'package:gtecgolsuperadmin/screens/admin/teacher_management/add_teacher.dart';
import 'package:gtecgolsuperadmin/screens/admin/teacher_management/teacher_in_batch.dart';
import 'package:provider/provider.dart';


class superAdminAddTeacher extends StatefulWidget {
  const superAdminAddTeacher({super.key});

  @override
  State<superAdminAddTeacher> createState() => _superAdminAddTeacherState();
}

class _superAdminAddTeacherState extends State<superAdminAddTeacher> {
  ...
  Widget _buildCourseItem(dynamic course, bool isSelected, SuperAdminauthprovider provider) {
    return InkWell(
      onTap: () {
        setState(() {
