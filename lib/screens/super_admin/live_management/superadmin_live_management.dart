...
class _AdminAddLiveCourseState extends State<AdminAddLiveCourse> {
  ...
  Widget _buildCourseSection(SuperAdminauthprovider provider) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildCourseList(SuperAdminauthprovider provider) {
    return Column(
      children: [
              ...
              return _buildListItem(
                ...
                onTap: () {
                  setState(() {
                    ...
                    provider.SuperAdminfetchBatchForCourseProvider(course.courseId);
                  });
                },
  ...
  Widget _buildBatchSection(SuperAdminauthprovider provider) {
...
class _LiveSessionManagementState extends State<LiveSessionManagement> {
  ...
  late Future<SuperAdminLiveLinkResponse?> liveDataFuture;
  ...
  void _refreshLiveData() {
    setState(() {
      liveDataFuture = Provider.of<SuperAdminauthprovider>(context, listen: false)
          .SuperadminfetchLiveAdmin(widget.batchId);
    });
  }
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate() && _selectedDateTime != null) {
                    try {
                      await context.read<SuperAdminauthprovider>().SuperAdmincreateLivelinkprovider(
                            widget.batchId,
  ...
  Widget _buildLiveSessionDetails(SuperAdminLiveLinkResponse liveLink) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await context
                      .read<SuperAdminauthprovider>()
                      .SuperAdmindeleteLiveprovider(widget.batchId,widget.courseId);
                  _refreshLiveData();
                  ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _showEditDialog(SuperAdminLiveLinkResponse liveLink) async {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _buildCreateSession(),
        FutureBuilder<SuperAdminLiveLinkResponse?>(
