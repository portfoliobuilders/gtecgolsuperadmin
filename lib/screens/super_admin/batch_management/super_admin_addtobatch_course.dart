...
import 'package:gtecgolsuperadmin/screens/super_admin/batch_management/super_admin_add_tobatch.dart';
import 'package:gtecgolsuperadmin/screens/super_admin/batch_management/super_adminstudents_in_batch.dart';
                    ...
                    return InkWell(
                      onTap: () {
                        setState(() {
                          ...
                          provider.SuperAdminfetchBatchForCourseProvider(
                              course.courseId);
                        });
                      },
                      child: Container(
