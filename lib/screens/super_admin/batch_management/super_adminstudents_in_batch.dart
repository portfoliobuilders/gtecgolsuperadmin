  ...
  Future<void> _loadStudents() async {
    try {
      await Provider.of<SuperAdminauthprovider>(context, listen: false)
          .SuperAdminfetchallusersBatchProvider(widget.courseId, widget.batchId);
      setState(() {
        isLoading = false;
      });
    } catch (e) {
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                await provider.SuperAdmindeleteUserFromBatchprovider(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Consumer<SuperAdminauthprovider>(
